...
namespace RESTWebAPI.Models
{
    public class Student : User
    {
        ...
        public Student( string firstName, string lastName, string phoneNumber, string email, string dateOfBirth, string educationEndDate, string nationality) : base(firstName, lastName, phoneNumber, email)
